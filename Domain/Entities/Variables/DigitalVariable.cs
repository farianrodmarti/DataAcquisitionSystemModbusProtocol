...
namespace Domain.Entities.Variables
{
    ...
    public class DigitalVariable : Variable
    {
        ...
        public DigitalVariable(string name, VariableType variableType, string code, string modbusProtocolDirection, List<Sample> samples, Guid unitId, Unit unit, ModbusSlave modbusSlave, Guid modbusSlaveId, Guid id) : base(name, variableType, code, modbusProtocolDirection, samples, unitId, unit, modbusSlave, modbusSlaveId, id)
        {
